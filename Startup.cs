...
namespace MultimediaDatabase
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Disabling the endpoint routing because there is an issue when upgrading from 2.0 to 30.0
            services.AddMvc(options => options.EnableEndpointRouting = false);

            //Adding a connection 
            string connection = @"Server=(localdb)\mssqllocaldb;Database=MultimediaDatabase;Trusted_Connection=True;ConnectRetryCount=0";
            //Adding Db Context
